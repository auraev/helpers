...
public class ColorsBase {
    ...
    public class func colorFromText(hexText: String) -> UIColor! {
    ...
    public class func colorFromHex(hexValue: UInt) -> UIColor {
    ...
    public class func textFromColor(color: UIColor) -> String {
        var result: String
